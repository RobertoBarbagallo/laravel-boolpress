...
<div class="container">
    <form action="{{ route('SuperAdmin.posts.update', $post) }}" method="post" id="postform" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
...
<div class="form-group">
    ...
    <input type="file" class="form-control-file" id="img" name="img" aria-describedby="imgHelp" placeholder="Inserisci il file">
